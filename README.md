...
Выполнено ДЗ. Создан backed-образ из образа ubuntu-1604-lts и на его основе создан образ с встроенными ruby, mongodb и автозапуском. Так же создан скрипт для автоматического развертывания инстанса из второго образа через gcloud.
Оба скрипта проверены, атозапуск и автодобавление правила фаервола по тегу работает, после развертывания инстанса можно сразу зайти на его ip-адрес по порту http/9292.
Все материалы выложены в соответствующе директории как указано в ДЗ.
